...
public class AddressBook {
    ...
    /***
     * created readContactJSONFile method to read the contact from AddressBook.json
     */
    private void readContactJSONFile() throws IOException {
        Gson gson = new Gson();
        Reader reader = Files.newBufferedReader(Paths.get
                ("C:\\Users\\sreen\\Desktop\\AddressBookSystem\\src\\main\\resources\\AddressBook.json"));
        Type collectionType = new TypeToken<List<Contact>>(){}.getType();
        Collection<Contact> contactCollection = gson.fromJson(reader, collectionType);
