...
public class AddressBook {
    ...
    private void readContactCSVFile() {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\sreen\\Desktop\\AddressBookSystem\\src\\main\\resources\\AddressBook.csv"));
            ...
            Iterator<Contact> personIterator = csvToBean.iterator();
